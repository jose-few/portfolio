...
<img src="${"/IMG_5905.JPG"}" alt="${"Me!"}" class="${"svelte-14kyso"}">
<div class="${"tw svelte-14kyso"}">${validate_component(Typewriter, "Typewriter").$$render(
    ...
    {
      default: () => {
        return `<p>I&#39;m a developer from Devon, England. I studied IT at Aberystwyth University, where I developed a passion for programming. Since graduating, I have been working as a Junior Developer at Hawksmoor, where I&#39;ve been developing not just code - but my skills as well. I&#39;m driven and hard working, and always eager to improve!
        </p>`;
      }
    }
  )}
